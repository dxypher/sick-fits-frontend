...
function (_Component) {
  ...
  function CreateItem() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "uploadFile", function (e) {
      ...
      data.append('upload_preset', 'sickfits'); // const res = await fetch("https://api.cloudinary.com/v1_1/ddkyjcdnj/image/upload");
    });
...
//# sourceMappingURL=sell.js.b6d76d1022b227c3508e.hot-update.js.map