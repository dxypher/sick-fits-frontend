...
function (_Component) {
  ...
  function DeleteItem() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "udpate", function (cache, payload) {
      // manually update the cache so UI matches server
      // read the Cache for items we want
      var data = cache.readQuery({
        ALL_ITEMS_QUERY: _Items__WEBPACK_IMPORTED_MODULE_3__["default"]
      });
      console.log(data);
    });
...
//# sourceMappingURL=items.js.7ae092700d5471293b3c.hot-update.js.map